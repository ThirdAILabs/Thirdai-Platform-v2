...
from prompt_resources.token_prompts import dataset_generation_prompt, tag_value_prompt
...
""".strip(
    ...
    def generate_using_existing_samples(
        self,
        task_prompt: str,
        tags: List[Entity],
        num_sentences_to_generate: int,
        ...
        from prompt_resources.token_prompts import dataset_generation_prompt_with_sample
