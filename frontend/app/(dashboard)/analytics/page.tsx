...
export default function AnalyticsPage() {
  ...
  const thirdaiPlatformBaseUrl = _.trim(
    ...
    <>
      ...
      <div className="mt-6">
        ...
        <p className="mb-4">
          ...
          duration users spend on the system. This indicates that users find the
          search system increasingly valuable and are willing to engage with it
          for longer periods.
        </p>
        ...
        <p className="mb-4">
          While the number of reformulated queries fluctuates, there&apos;s an
          overall downward trend. This suggests that users are becoming more
          adept at finding the information they need on the first attempt,
          indicating improved search accuracy and user satisfaction.
        </p>
      </div>
