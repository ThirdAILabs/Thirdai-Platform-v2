...
from headless.utils import fetch_job_definition, restart_nomad_job, stop_nomad_job, update_docker_image_version
...
if __name__ == "__main__":
    ...
    new_definition = update_docker_image_version(job_definition=definition, new_version="34.56.78.90")
    
    print(new_definition, flush=True)
