export const agnewsUpvotes = [
    ...
    {
        "query": "What are the highlights of the new technologies featured at the global tech conference?",
...
export const agnewsAssociations = [
    {
    ...
    {
        "source": "What are the potential applications of the cutting-edge technology from the university?",
...
export const agnewsReformulations = [
    {
        "original": "How did scientists find the new planet?",
        "reformulations": [
            "Which new planet did scientists recently discover?"
        ]
    },
    {
