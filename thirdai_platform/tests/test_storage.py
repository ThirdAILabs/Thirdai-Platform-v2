...
def test_insert_samples_buffer_limit(data_storage, sample_data):
...
def test_metadata_status_after_training(data_storage, tag_metadata):
    ...
    data_storage.update_tag_metadata(tag_metadata)
...
def test_sample_status_after_training(data_storage, sample_data):
    data_storage.insert_samples([sample_data] * 10)
...
def test_remove_untrained_samples(data_storage, sample_data):
