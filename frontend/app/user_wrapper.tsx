...
export const UserContext = createContext<UserContext>({user: null, accessToken: null, setAccessToken: (user) => {}, logout: () => {}});
...
export default function UserWrapper({children} : {children: React.ReactNode}) {
  ...
  return <UserContext.Provider value={{ user, accessToken, setAccessToken, logout }}>
    {children}
