...
export default function Interact() {
  ...
  return (
    <div className="bg-muted" style={{width: "100%", display: "flex", flexDirection: "column", justifyContent: "start", height: "100vh"}}>
      ...
      <div style={{display: 'flex', flexDirection: 'row', justifyContent: "space-around", gap: "20px", width: '100%', marginTop: "5vh"}}>
        ...
        <div style={{transition: "0.25s", width: showFeedback ? "25%" : "0"}}>
          <UnsavedFeedback feedbackEntries={[{text: "Hello there", tag: "NAME", remove: () => console.log("Remove hello there")}, {text: "Hello here", tag: "NAME", remove: () => console.log("Remove hello here")}]} tagColors={Object.fromEntries(Object.keys(tagColors).map(key => [key, tagColors[key].tag]))} />
        </div>
      </div>
    </div>
  );
