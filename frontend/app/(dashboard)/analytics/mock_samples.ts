export const upvotes = [
  ...
  {
    query:
      'What type of cuisine will the famous chef\u2019s new restaurant offer?',
  ...
  {
    query:
      'What are the objectives of the new Mars mission announced by the space agency?',
    upvote: 'International space agency announces mission to Mars'
  },
  {
    query:
      'What new project is the tech company partnering on with the startup?',
  ...
  {
    query:
      'How will the new technology developed by the university impact its industry?',
  ...
  {
    query:
      'What is the timeline for the new infrastructure project announced by the government?',
  ...
  {
    query:
      "How can people participate in the environmental group's conservation efforts?",
  ...
  {
    query:
      'How are the latest innovations being presented at the tech conference?',
    upvote: 'Global tech conference features new innovations'
  },
  {
    query:
      "What is the significance of the university's record number of applicants?",
  ...
  {
    query:
      'What changes are included in the new educational reform by the government?',
    upvote: 'Government implements new educational reform'
  },
  {
    query:
      'What new innovations are being showcased at the global tech conference?',
    upvote: 'Global tech conference features new innovations'
  },
  {
    query:
      'How does the university\u2019s new technology stand out in its field?',
    upvote: 'University develops cutting-edge technology'
  },
  {
    query:
      'How can people participate in the charity event hosted by the local center?',
    upvote: 'Local community center hosts charity event'
  },
  {
    query:
      'How is the new restaurant different from the chef\u2019s previous ventures?',
    upvote: 'Famous chef opens new restaurant'
  },
  {
    query:
      'What types of films are featured at the international film festival?',
    upvote: 'International film festival showcases diverse films'
  },
  {
  ...
  {
    query:
      'Which new innovations are attracting attention at the tech conference?',
    upvote: 'Global tech conference features new innovations'
  },
  {
  ...
  {
    query:
      'What goals does the new conservation campaign by the environmental group have?',
    upvote: 'Environmental group launches conservation campaign'
  },
  {
    query:
      'Who are the investors behind the tech startup\u2019s major funding?',
    upvote: 'Tech startup secures major funding'
  },
  {
  ...
  {
    query:
      'What themes are explored in the famous artist\u2019s new collection?',
...
export const associations = [
  {
    source:
      'What activities are planned for the charity event at the community center?',
  ...
  {
    source:
      'How will the renovation affect the historic building\u2019s appearance?',
    target: 'Historic building undergoes renovation'
  },
  {
    source:
      'How will the charity event at the community center benefit the cause?',
    target: 'Local community center hosts charity event'
  },
  {
    source:
      'What technologies will be used in the Mars mission by the space agency?',
  ...
  {
    source:
      'What does the sales milestone mean for the future of the local business?',
    target: 'Local business achieves milestone in sales'
  },
  {
    source:
      'How will the partnership between the tech company and the startup work?',
    target: 'Tech company partners with startup for new project'
  },
  {
    source:
      'Where can viewers see the new art collection by the famous artist?',
  ...
  {
    source:
      'How is the environmental group planning to execute their conservation campaign?',
    target: 'Environmental group launches conservation campaign'
  },
  {
    source:
      'What charity is being supported by the event at the local community center?',
    target: 'Local community center hosts charity event'
  },
  {
    source:
      'How is the new collection by the artist being received by critics?',
    target: 'Famous artist exhibits new collection'
  },
  {
  ...
  {
    source:
      'What are the key aspects of the environmental group\u2019s new campaign?',
    target: 'Environmental group launches conservation campaign'
  },
  {
    source:
      'How did the local business reach this significant sales milestone?',
    target: 'Local business achieves milestone in sales'
  },
  {
  ...
  {
    source:
      'What are the highlights of the famous artist\u2019s latest exhibition?',
    target: 'Famous artist exhibits new collection'
  },
  {
  ...
  {
    source:
      'What is the timeline for the international space agency\u2019s Mars mission?',
    target: 'International space agency announces mission to Mars'
  },
  {
  ...
  {
    source:
      'What was the reaction to the sports star breaking the world record?',
    target: 'Sports star breaks world record'
  },
  {
    source:
      'What are the objectives of the tech company\u2019s collaboration with the startup?',
    target: 'Tech company partners with startup for new project'
  },
  {
    source:
      'How does the film festival contribute to the global film industry?',
    target: 'International film festival showcases diverse films'
  },
  {
    source:
      'What are the main features of the famous chef\u2019s new restaurant?',
    target: 'Famous chef opens new restaurant'
  },
  {
  ...
  {
    source:
      "What are the goals of the government's infrastructure development project?",
  ...
  {
    source:
      'How will the startup benefit from its partnership with the tech company?',
    target: 'Tech company partners with startup for new project'
  },
  {
  ...
  {
    source:
      'What impact does the world record have on the sports star\u2019s career?',
    target: 'Sports star breaks world record'
  },
  {
  ...
  {
    source:
      'What changes are being made during the renovation of the historic building?',
    target: 'Historic building undergoes renovation'
  },
  {
    source:
      'What factors contributed to the record number of applicants at the university?',
  ...
  {
    source:
      'What details are available about the new infrastructure development project?',
    target: 'Government announces infrastructure development project'
  },
  {
    source:
      'What features are included in the new public park opened by the city?',
...
export const reformulations = [
  ...
  {
    original:
      'What severe weather conditions is the nation currently experiencing?',
    reformulations: [
  ...
  {
    original:
      'What are the details of the government\u2019s investment in renewable energy?',
    reformulations: [
  ...
  },
  {
    ...
    reformulations: [
      'How did the government describe their latest economic policy?'
    ]
  },
  {
    original: 'What are the economists predicting about GDP growth?',
    reformulations: [
      'What is the expected impact on the economy based on GDP growth predictions?'
    ]
  },
  {
    original:
      'What are the highlights of the international music festival in the city?',
    reformulations: [
