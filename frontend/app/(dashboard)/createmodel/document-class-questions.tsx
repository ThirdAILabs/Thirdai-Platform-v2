...
export default function DocumentClassificationQuestions({ workflowNames }: DocumentClassificationQuestionsProps) {
    ...
    const validateFolderStructure = (files: FileList) => {
        ...
        if (rootHasFiles) {
            ...
            setFolderValidationMessage('The root folder cannot contain files. It must only contain sub-folders.');
        return;
        }
    ...
    <div>
        ...
        <div>
            ...
            <div key={index} style={{ marginTop: "10px" }}>
                ...
                <Button variant="destructive" onClick={() => deleteSource(index)}>Delete</Button>
            </div>
            ))}
        </div>
        ...
        <div className="flex justify-start">
            <Button onClick={() => console.log('Submit Document Classification')} style={{ marginTop: "30px", width: "100%" }}>
            Create
            </Button>
        </div>
    </div>
